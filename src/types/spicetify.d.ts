declare namespace Spicetify {
	...
	interface PlaylistContentsItem {
		uri?: string;
		link?: string;
		[key: string]: unknown;
	}
	interface PlaylistContentsResponse {
		items?: PlaylistContentsItem[];
		[key: string]: unknown;
	}
	interface PlaylistInsertOptions {
		before?: string;
		after?: string;
		[key: string]: unknown;
	}
	interface PlaylistAPI {
		getContents?(uri: string, options?: Record<string, unknown>): Promise<PlaylistContentsResponse>;
		getMetadata?(uri: string, options?: Record<string, unknown>): Promise<PlaylistMetadata | null | undefined>;
		add?(
			playlistUri: string,
			uris: string[],
			options: PlaylistInsertOptions,
			signal?: unknown
		): Promise<void>;
		[key: string]: unknown;
	}
	interface RootlistAPI {
		getContents?(options?: Record<string, unknown>): Promise<unknown>;
		getRootContents?(): Promise<unknown>;
		[key: string]: unknown;
	}
